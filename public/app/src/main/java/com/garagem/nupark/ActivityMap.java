...
public class ActivityMap extends AppCompatActivity implements
    ...
    public void onMapReady(GoogleMap map) {
        GMap = map;
        mapReady = true;
        if (ActivityCompat.checkSelfPermission(ActivityMap.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(ActivityMap.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
...
/*
    ...
    private void permissionCheck() {
        ...
        if (ActivityCompat.checkSelfPermission(ActivityMap.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(ActivityMap.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(ActivityMap.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
        }
...
//    private List<Branche> mfiliais;
    ...
    private boolean isGooglePlayServicesAvailable() {
        int status = GooglePlayServicesUtil.isGooglePlayServicesAvailable(ActivityMap.this);
        if (ConnectionResult.SUCCESS == status) {
            return true;
        } else {
            GooglePlayServicesUtil.getErrorDialog(status, ActivityMap.this, 0).show();
            return false;
        }
    }
